...
import ui.dataPages.DataPageController;
import ui.inputOutputPages.DataIOPageController;
...
public class MainPageController extends UIController {
    ...
    private void startRaceButtonAction() {
        ...
        loadNextPage("/ui/TimingPages/TimingPage.fxml", c -> new TimingPageController(controller));
    }

    @FXML
    private void ioDataButtonAction() {
        loadNextPage("/ui/inputOutputPages/dataIOPage.fxml", c -> new DataIOPageController(controller));
    }
    ...
    private void dataViewButtonAction() {
        ...
        loadNextPage("/ui/dataPages/DataPage.fxml", c -> new DataPageController(controller));
    }
    ...
    private void loadNextPage(String pathToPage, Callback<Class<?>, Object> fun) {
        try {
            FXMLLoader root = new FXMLLoader(getClass().getResource(pathToPage));
